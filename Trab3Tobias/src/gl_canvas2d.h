...
public:
    ...
    //Triangle Fil
    static void triangleFill(float vx[], float vy[]); //desenha um triangulo preenchido. Para um triangulo, deve-se passar 3 vertices
    static void triangleFill(Vector2 p1, Vector2 p2, Vector2 p3); //desenha um triangulo preenchido. Para um triangulo, deve-se passar 3 vertices
    ...
    //desenha texto vetorial (mais suave) na coordenada (x,y)
    static void textStroke(float x, float y, const char *t, float scale = 0.1f, float lineWidth = 2.0f);
